<template>
    <b-container fluid>
        ...
        <b-table :items="myProvider" :busy="isBusy" class="mt-3" :fields="fields" ref="table">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            info(item) {
                let model = { Email: item.Email, Role: item.Role }
                this.infoModal.content = JSON.stringify(model, null, 2)
